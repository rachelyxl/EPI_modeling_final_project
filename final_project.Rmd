...
# the reproduction number R0 is 1.31(1.48), 1.23(1.26), 1.08(1.16). R0 = beta/(mu + gamma). beta = R0 * (gamma + mu), 0.41. R0 in () is the estimated R0 by our team. and R0 = 1.31, 1.23, and 10.8 is provided by the article. 
...
params_phase2 <- c(beta = 0.36, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 0.73, rho = 0.8)  # Adjust Cj and rho for Phase 2
params_phase3 <- c(beta = 0.33, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 0.44, rho = 0.75)  # Adjust Cj and rho for Phase 3
...
Rt_values <- 1.48 * params_phase1["Cj"] * (result_all_phases[, "S"] / params_phase1["N"])

# Update Rt values for Phase 2
Rt_values[time_phase2] <- 1.26 * params_phase2["Cj"] * (result_all_phases[time_phase2, "S"] / params_phase2["N"])

# Update Rt values for Phase 3
Rt_values[time_phase3] <- 1.16 * params_phase3["Cj"] * (result_all_phases[time_phase3, "S"] / params_phase3["N"])
