...
# the reproduction number R0 is 1.31(1.48), 1.23(1.26), 1.08(1.16). R0 = beta/(mu + gamma). beta = R0 * (gamma + mu), 0.41. R0 in () is the estimated R0 by our team assume the exponential growth phase. and R0 = 1.31, 1.23, and 1.08 is provided by the article. 
