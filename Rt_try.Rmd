...
# the reproduction number R0 is 1.31(1.48), 1.23(1.26), 1.08(1.16). R0 = beta/(mu + gamma). beta = R0 * (gamma + mu), 0.41. R0 in () is the estimated R0 by our team. and R0 = 1.31, 1.23, and 1.08 is provided by the article. 
# the process of estimate R0 can be found in the para_est.RMD file. 

#######changes by Wenyan#######

## Phase 1: R0 from serial interval is 1.48, get beta = 0.42
params_phase1 <- c(beta = 0.42, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 1, rho = 0.9)

## phase 1 tail: S/N = 0.8033

## phase 2: Rt = 1.48*0.8033 = 1.188884, beta = 0.3397

params_phase2 <- c(beta = 0.3397, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 0.73, rho = 0.8)  # Adjust Cj and rho for Phase 2

## phase 3 tail: S/N = 0.864325452

## phase 3: Rt = 0.864325452* 1.188884 = 1.02758, beta = 0.2936

params_phase3 <- c(beta = 0.2936, gamma = 1/3.5, mu = 1/3.5, omega = 2*pi/365, N = 7395278, Cj = 0.44, rho = 0.75)  # Adjust Cj and rho for Phase 3
