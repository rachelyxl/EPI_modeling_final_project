...
# the reproduction number R0 is 1.33(1.33), 0.94(1.26), 0.89(1.16). R0 = beta/(mu + gamma). beta = R0 * (gamma + mu), 0.41. R0 in () is the estimated R0 by our team use MLE method. and R0 = 1.31, 1.23, and 1.08 is provided by the article. 
# the process of estimate R0 can be found in the para_est.RMD file. 

#######changes by Wenyan#######

## Phase 1: R0 from MLE estimate is 1.33, get beta = 0.42
params_phase1 <- c(beta = 0.38, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 1, rho = 0.9)

## phase 1 tail: S/N = 0.8036009

## phase 2: Rt = 1.33*0.8036009 = 1.068789, beta = 0.3054027

params_phase2 <- c(beta = 0.3054027, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 0.73, rho = 0.8)  # Adjust Cj and rho for Phase 2

## phase 3 tail: S/N = 0.865024

## phase 3: Rt = 0.865024* 1.068789 = 0.9245281, beta = 0.2641807

params_phase3 <- c(beta = 0.2641807, gamma = 1/3.5, mu = 1/3.5, omega = 2*pi/365, N = 7395278, Cj = 0.44, rho = 0.75)  # Adjust Cj and rho for Phase 3
