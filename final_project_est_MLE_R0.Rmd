...
# the reproduction number R0 is 1.33(1.48), 0.94(1.26), 0.89(1.16). R0 = beta/(mu + gamma). beta = R0 * (gamma + mu), 0.41. R0 in () is the estimated R0 by our team use MLE method. and R0 = 1.31, 1.23, and 1.08 is provided by the article. 
...
params_phase2 <- c(beta = 0.27, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 0.73, rho = 0.8)  # Adjust Cj and rho for Phase 2
params_phase3 <- c(beta = 0.25, gamma = 1/3.5, mu = 1/85/365, omega = 2*pi/365, N = 7395278, Cj = 0.44, rho = 0.75)  # Adjust Cj and rho for Phase 3
